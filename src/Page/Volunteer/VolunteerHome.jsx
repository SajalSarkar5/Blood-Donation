                ...
                <div class="bg-gradient-to-b from-violet-600/[.15] via-transparent">
                    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
                        ...
                        <div class="max-w-3xl text-center mx-auto">
                            ...
                            Building life-saving products is easier than ever.
                            </h1>
                        </div>
                        

                        <div class="max-w-3xl text-center mx-auto">
                            <p class="text-lg text-gray-400">Now it's easier than ever to create impactful solutions. Join our mission to build products that save lives, just as blood donation transforms communities.</p>
                        </div>
