                    ...
                    <div class="-mx-4 flex flex-wrap">
                        <div class="w-full px-4">
                            <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                                <span class="text-primary mb-2 block text-xl font-semibold">
                                Featured section
                                </span>
                                <h2
                                ...
                                <p class="text-body-color text-base dark:text-dark-6">
                                    Experience the joy of giving. Our Blood Donation program offers a chance to make a life-saving impact. Join us in this noble cause and be a part of something extraordinary.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <p class="text-body-color dark:text-dark-6">
                                    Join us for a community blood drive and contribute to saving lives. Your donation can make a significant impact on someone in need. Refreshments will be provided.
                                </p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <p class="text-body-color dark:text-dark-6">
                                    The mobile blood donation unit will be stationed at the town square. Walk-ins are welcome, and the process is quick and easy. Help us ensure a stable blood supply for local hospitals.
                                </p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <p class="text-body-color dark:text-dark-6">
                                    Participate in our blood donation marathon and be a hero in your community. Every donor will receive a thank-you gift, and there will be fun activities for families. Let's come together for a good cause!
                                </p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <h4 class="text-dark dark:text-white mb-[14px] text-2xl font-semibold">
                                    Student Blood Donor Challenge
                                </h4>
                                <p class="text-body-color dark:text-dark-6">
                                    Calling all students! Take part in the blood donor challenge and compete with other schools to see who can contribute the most units. Help us reach our donation goal and earn bragging rights for your school.
                                </p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <p class="text-body-color dark:text-dark-6">
                                    Neighbors helping neighbors! Join us for a neighborhood blood drive at the community center. Donating blood is a simple way to give back to the community and support those in medical need.
                                </p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                            ...
                            >
                                ...
                                <h4 class="text-dark dark:text-white mb-[14px] text-2xl font-semibold">
                                    Lifeblood Heroes: Answer the Call to Save Lives!
                                </h4>
                                <p class="text-body-color dark:text-dark-6">
                                    Be a lifesaver! Join our Blood Donation campaign, make a difference, and share the gift of life. Your contribution matters. Act now!
                                </p>
                            </div>
                        </div>
                    </div>
